...
//LCOMPLEX AGBGEN18
#define LCOMPLEX			"COMPLEXFLOAT"
#define LFLOAT			"FLOAT"
#define LINT				"INT"
#define LCHAR			"CHAR"				/* Defines a char where all bits used*/
#define LBITS			"BITS"				/* Defines a char where only LSB bit is used*/

/* input and output data types */
typedef _Complex float  input_t;			//_Complex float, float, int, char, char
#define IN_TYPE			LCOMPLEX		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
...
#define OUT_TYPE		LCOMPLEX		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
